...
void Histogram__rosidl_typesupport_introspection_c__Histogram_init_function(
...
void Histogram__rosidl_typesupport_introspection_c__Histogram_fini_function(void * message_memory)
{
  multisense_msgs__msg__Histogram__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Histogram__rosidl_typesupport_introspection_c__Histogram_message_member_array[10] = {
  {
    "frame_count",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Histogram__rosidl_typesupport_introspection_c__Histogram_message_members = {
  "multisense_msgs__msg",  // message namespace
  "Histogram",  // message name
  10,  // number of fields
  sizeof(multisense_msgs__msg__Histogram),
  Histogram__rosidl_typesupport_introspection_c__Histogram_message_member_array,  // message members
  Histogram__rosidl_typesupport_introspection_c__Histogram_init_function,  // function to initialize message memory (memory has to be allocated)
  Histogram__rosidl_typesupport_introspection_c__Histogram_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t Histogram__rosidl_typesupport_introspection_c__Histogram_message_type_support_handle = {
  0,
  &Histogram__rosidl_typesupport_introspection_c__Histogram_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, multisense_msgs, msg, Histogram)() {
  Histogram__rosidl_typesupport_introspection_c__Histogram_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  if (!Histogram__rosidl_typesupport_introspection_c__Histogram_message_type_support_handle.typesupport_identifier) {
    Histogram__rosidl_typesupport_introspection_c__Histogram_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &Histogram__rosidl_typesupport_introspection_c__Histogram_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
